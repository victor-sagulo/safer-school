...
export class tablesCreation1652812810727 implements MigrationInterface {
    name = 'tablesCreation1652812810727'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "relative_students_student" ("relativeId" uuid NOT NULL, "studentId" uuid NOT NULL, CONSTRAINT "PK_251a1e5507b07c333f9bc4f9106" PRIMARY KEY ("relativeId", "studentId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_2bc4fd282e166caadebaf84b41" ON "relative_students_student" ("relativeId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0882ce3de96b6c091c55daf9d4" ON "relative_students_student" ("studentId") `);
        ...
        await queryRunner.query(`ALTER TABLE "student_relatives_relative" ADD CONSTRAINT "FK_e92ad911bc4bbaeab0ed465ecb6" FOREIGN KEY ("relativeId") REFERENCES "relative"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "relative_students_student" ADD CONSTRAINT "FK_2bc4fd282e166caadebaf84b415" FOREIGN KEY ("relativeId") REFERENCES "relative"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "relative_students_student" ADD CONSTRAINT "FK_0882ce3de96b6c091c55daf9d40" FOREIGN KEY ("studentId") REFERENCES "student"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "relative_students_student" DROP CONSTRAINT "FK_0882ce3de96b6c091c55daf9d40"`);
        await queryRunner.query(`ALTER TABLE "relative_students_student" DROP CONSTRAINT "FK_2bc4fd282e166caadebaf84b415"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_0882ce3de96b6c091c55daf9d4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2bc4fd282e166caadebaf84b41"`);
        await queryRunner.query(`DROP TABLE "relative_students_student"`);
